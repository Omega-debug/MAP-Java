...
import console.Exception.IntervalValidator;
import console.Exception.DateValidator;
    ...
    public void start(Stage stage) throws IOException {
        ...
        stergeMasinaButton.setOnMouseClicked(new EventHandler<MouseEvent>() {
            ...
            public void handle(MouseEvent mouseEvent) {
                ...
                try {
                    if(serviceMasini.nrMasini()==1) throw new ExistingException("Trebuie sa existe cel putin o masina in lista.");
                    int id = Integer.parseInt(idTextField.getText());
                    //String marca = marcaTextField.getText();
                    //String model = modelTextField.getText();
        ...
        adaugaInchiriereButton.setOnMouseClicked(new EventHandler<MouseEvent>() {
            ...
            public void handle(MouseEvent mouseEvent) {
                ...
                try {
                    ...
                    IntervalValidator dateIntervalsValidator = new IntervalValidator();
                    dateValidator.verifData(datai);
                    dateValidator.verifData(dataf);
                    dateIntervalsValidator.Verif(datai,dataf);
        ...
        stergeInchiriereButton.setOnMouseClicked(new EventHandler<MouseEvent>() {
            ...
            public void handle(MouseEvent mouseEvent) {
                ...
                try {
                    if(serviceInchirieri.nrInchirieri()==1) throw new ExistingException("Trebuie sa existe cel putin o masina in lista.");
                    int id = Integer.parseInt(idInchiriereTextField.getText());
