...
public class InchiriereValidator {
    ...
    public void verifInchiriere(String line1, String line2, String line3, String line4) throws WrongException {
        ...
        if (an1==an2 && an1==an3 && an1== an4 && (luna2==luna3 || luna1==luna4))
            if (zi3<=zi2 && zi4>=zi1)
                throw new WrongException("datele introduse se suprapun cu o alta inchiriere\n");
            else return;
